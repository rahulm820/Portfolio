  ...
  return (
    <footer className="site-footer">
      <div className="container">
        {/* Row 1: Name + Social + Back-to-top */}
        <div className="footer-row-1">
          <div className="footer-brand">
            <span className="footer-name">Rahul Madhawani</span>
            <span className="footer-tagline">Building ideas into reality.</span>
          </div>
        ...
        <div className="footer-row-2">
          {navLinks.map(link => (
            <a key={link.href} href={link.href} className="footer-nav-link">{link.label}</a>
          ))}
        </div>

        {/* Row 3: Copyright */}
        <div className="footer-row-3">
          <span>© {new Date().getFullYear()} Rahul Madhawani. All rights reserved.</span>
